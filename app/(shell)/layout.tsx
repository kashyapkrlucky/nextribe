      ...
      <div className="w-full flex flex-col lg:flex-row gap-4 max-w-7xl mx-auto">
        ...
        <aside className="flex flex-col lg:w-1/5 gap-4">
          <div className="bg-white border border-gray-200 rounded-xl p-3">
            <h3 className="text-sm font-semibold mb-2">Important</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="bg-blue-50 p-4">
              <div className="w-16 h-16 rounded-full bg-white border border-gray-200 shadow-sm mb-2" />
              <p className="font-medium">{MOCK_USER.name}</p>
              <p className="text-xs text-slate-600">{MOCK_USER.title}</p>
            </div>
            <div className="p-3">
              <a
