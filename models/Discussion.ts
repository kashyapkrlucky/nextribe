 ...
 */
const DiscussionSchema = new Schema<IDiscussion & Document>(
  {
    title: { 
      type: String, 
 ...
 */
DiscussionSchema.pre('deleteOne', { document: true }, async function(next: (err?: Error) => void) {
 ...
 */
DiscussionSchema.statics.findByCommunity = function(communityId: string, options: { 
  page?: number, 
  limit?: number,
 ...
 */
export const Discussion: Model<IDiscussion & Document> =
  models.Discussion || mongoose.model<IDiscussion & Document>("Discussion", DiscussionSchema);
