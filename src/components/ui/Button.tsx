...
const variantClasses = {
  ...
  outline: "border border-gray-400 bg-transparent text-gray-500 focus:ring-2 focus:ring-gray-500",
...
export default function Button({
  ...
  return (
    <button
      className={`inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-colors focus:outline-none cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed ${
        sizeClasses[size]
